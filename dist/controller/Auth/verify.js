...
if (!cognitoPoolId) {
    throw new errors_1["default"]('env var required for cognito pool', 400);
}
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                url = "".concat(cognitoIssuer, "/.well-known/jwks.json");
        ...
        switch (_a.label) {
            case 0:
                ...
                if (tokenSections.length < 2) {
                    throw new errors_1["default"]('requested token is invalid', 401);
                }
            ...
            case 1:
                ...
                key = keys[header.kid];
                if (key === undefined) {
                    throw new errors_1["default"]('claim made for unknown kid', 401);
                }
                return [4 /*yield*/, verifyPromised(token)];
            case 2:
                claim = _a.sent();
                currentSeconds = Math.floor((new Date()).valueOf() / 1000);
                if (currentSeconds > claim.exp || currentSeconds < claim.auth_time) {
                    throw new errors_1["default"]('claim is expired or invalid', 401);
                }
                if (claim.iss !== cognitoIssuer) {
                    throw new errors_1["default"]('claim issuer is invalid', 401);
                }
                if (claim.token_use !== 'access') {
                    throw new errors_1["default"]('claim use is not access', 401);
                }
